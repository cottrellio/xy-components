...
define('dummy/tests/integration/components/xy-menu-icon/component-test', ['ember-qunit'], function (_emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      "id": "tXpJ3oM0",
      "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"xy-menu-icon\",null,null,{\"statements\":[[0,\"      template block text\\n\"]],\"parameters\":[]},null],[0,\"  \"]],\"hasEval\":false}",
      "meta": {}
    }));
...
define('dummy/tests/unit/mixins/padding-margin-test', ['xy-components/mixins/padding-margin', 'qunit'], function (_paddingMargin, _qunit) {
  'use strict';
